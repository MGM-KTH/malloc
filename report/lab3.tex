...
I appendix finns källkoden för |malloc.c|, |malloc.h| samt testfilerna |malloc_test_small.c| och |malloc_test_big.c|. \\
...
När |free| har hittat var det nya friade blocket ska länkas in så görs en koll om
blocket framför i listan gränsar till det nya blocket och om blocket
